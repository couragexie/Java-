							...
							<div class="info">
								<table border=0 cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td><%=studentInfo.getClass_()%></td>
										<td><%=studentInfo.getPosition()%></td>
										<td><%=studentInfo.getDormitory()%></td>
										<td><%=studentInfo.getPhoneNum()%></td>
						...
						<div class="content">
							...
							%>
									<tr>
										...
										<td><%=c.getCname() %></td>
										<td><%=c.getCredit() %></td>
										<td><a href="ChooseCourseServlet?action=choose&cid=<%=c.getCid()%>&sid=<%=studentInfo.getsId() %>">选课</a></td>
									</tr>
							<%}} %>
							</table>
							</div>
							...
							<div class="table-info">
								<table  border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td><%=sc.getCname() %></td>
										<td><%=sc.getCredit() %></td>
										<td><a href="ChooseCourseServlet?action=giveup&cid=<%=sc.getCid()%>&sid=<%=studentInfo.getsId() %>">弃选</a></td>
									</tr>
									<%}}} %>
								</table>
							</div>
