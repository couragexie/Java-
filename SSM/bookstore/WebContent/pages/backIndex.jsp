...
<head>
    ...
    <link href="${pageContext.request.contextPath }/css/backIndex.css" rel="stylesheet">
</head>
<body>
...
<script src="${pageContext.request.contextPath }/js/backIndex.js"></script>
...
<%
	...
	Integer id = (Integer)session.getAttribute("adID");
    if(id == null){
%>
    <script>
        alert("你还没有登录，请先登录");
...
<div class="main">
    ...
    <div class="section">
        ...
        <hr>
        <div class="content">
            <form class="form-inline" method="POST" action="${pageContext.request.contextPath}/book" enctype="multipart/form-data">
                <!-- 图片上传 -->
                <div class="showImg">
                ...
                <div class="info">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input" name="price" placeholder="请输入价格">
                    </div><br>
                    <div class="form-group">
